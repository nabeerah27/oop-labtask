...
public class Program {
    ...
    public void run() {
        ...
        System.out.println("Angle between v1 and v2 in radians: " + String.format("%.3f", angleRad) + " radians. ");
        System.out.println("Angle between v1 and v2 in degrees: " + String.format("%.3f", angleDeg) + " degrees. ");
        System.out.println();
